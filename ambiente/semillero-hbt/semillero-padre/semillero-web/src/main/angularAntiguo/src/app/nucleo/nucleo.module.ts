...
import { GestionVehiculoComponent } from './capa/principal/gestion-vehiculo/gestion-vehiculo.component';
...
@NgModule({
  declarations: [CapaComponent, EncabezadoComponent, PrincipalComponent, PiePaginaComponent, CreacionPersonasComponent, ApoyoComponent, GestionVehiculoComponent],
  imports: [
